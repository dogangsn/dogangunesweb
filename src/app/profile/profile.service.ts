...
export class ProfileService {
  ...
  projects: any = [
    {
      ...
      desc: '',
      livedemo: '',
      githurl: 'https://github.com/dogangsn/Passionflower',
      imgUrl: 'assets/images/z1.png',
      tech: 'Asp.NET Core , MSSQL',
    },
  ...
  about2 = `5+ yıllık deneyime sahip Yazılım Geliştiricisi .
  Yazılım Geliştirme Yaşam Döngüsü (SDLC) ve çevik metodolojilerle çalışmaktayım `;

  about =
    'Sektörde profesyonel olarak 2015 yılından itibaren yazılım geliştirici olarak çalışmaktayım. Masaüstü uygulamaları, Web Otomasyonları, API sevişleri geliştirmekteyim. ASP.NET teknolojilerini aktif olarak kullanmaktayım. Profesyonel olarak C#, ASP.NET platformları ile kendimi geliştirmeye devam etmekteyim. SOLID yazılım prensipleriyle çok katmanlı ve temiz kodlama yapmaya özen gösteriyorum.Bilirsiniz ki son teknolojileri takip de kalmamız ve kendimizi geliştirmeye devam etmekteyiz. Her türlü bilgi ve öğrenmeye her zaman açığım.';
  resumeurl =
    'https://docs.google.com/document/d/1WODFuhIzQw2AXPsjt6f3rs-EDWhdhT8s89fOTrGRh70/edit?usp=sharing';
...
Completed my Secondary school with 84%.`,
  ...
  exprienceData: any = [
    {
      ...
      company: 'Sednacloud',
      location: 'Antalya',
      timeline: 'Haz 2017 - Halen',
      role: 'ERP Software Project Team Leader',
      work: `Teknoloji : Asp.NET , C# , MSSQL .

      Project 1 : ERP Sistemleri 

      `,
    },
    {
      id: 1,
      company: 'İm Park Eğitim Bilişim Ltd. Şti.',
      location: 'Ankara - Ostim Teknokent',
      timeline: 'Ağu 2015 - Haz 2016',
      role: 'Software Engineer - Stajyer',
      work: '',
    },
  ];
  ...
  extraCircularInfo: any = [
    ...
    // },
    {
      ...
      title: 'Github',
      description: '',
      img: 'assets/images/dogangunesgithub.png',
      url: 'https://github.com/dogangsn',
    },
    {
      id: 1,
      title: 'Freelancing',
      description: '',
      img: 'assets/images/dogan_upwork.png',
      url: 'https://www.upwork.com/freelancers/~01d50786fcae77f324',
    },
  ];
